        ...
        <link rel="stylesheet" href="<?php echo base_url() . '/assets/frontend/'; ?>css/hint.css">
            ...
            <script type="text/javascript">
                ...
                function selectCountry(country) {
                    ...
                    var country_value = $.cookie("country");
                    if(country_value == country){
                         $('#country_remember').attr('checked', true);
                    }
                    else{
...
<?php echo $this->security->get_csrf_token_name() . ":'" . $this->security->get_csrf_hash() . "'"; ?>
                ...
                $(document).ready(function () {
                    ...
                    if (user_id != "") {
                        bootbox.alert('Please Check Your Mail to Confirm Registration...', function () {
                ...
                function checkCookiesCity(city){
                    var cookie_city_val = $.cookie("city");
                    
                    if(cookie_city_val == city){
                         $('#city_remember').attr('checked', true);
                    }
                    else{
                  ...
                  function retailerChangeForCookie(retailer){
                    var retailer_city_val = $.cookie("retailer");
                    
                    if(retailer_city_val == retailer){
                         $('#retailer_remember').attr('checked', true);
                    }
                    else{
    ...
    <input type="hidden" name="uuu_id" value="<?php
    if (!empty($registerUser)) {
        echo $registerUser['user_id'];
    }
    ?>" id="uuu_id"/>
    <body>
        ...
        <div class="container-fluid">
            <div class="container less_pad">
                ...
                <div class="col-lg-12">
                    <div class="big_banner" id="fadeOne">
                        <?php foreach ($banner_images['bigbanner'] as $bigbanner): ?>
                            <img src="<?php echo base_url() . 'images/admin/' . $bigbanner->image_name; ?>" alt="Banner" title="" class="img-responsive" width="100%" link="<?php
                            if (!empty($bigbanner->image_url)) {
                                echo $bigbanner->image_url;
                            } else {
                                echo '#';
                            }
                            ?>"/>         
                        ...
                        <div class="lt_banner_top" id="fadeTwo">
                            ...
                            foreach ($banner_images['small_top_banner'] as $small_top_banner):
                                ...
                                if ($i > $topLeft) {
                                    ...
                                    ?>
                                    <img src="<?php echo base_url() . 'images/admin/' . $small_top_banner->image_name; ?>" alt="Banner" class="img-responsive" width="100%" link="<?php
                                         if (!empty($small_top_banner->image_url)) {
                                             echo $small_top_banner->image_url;
                                         } else {
                                             echo '#';
                                         }
                                         ?>" />
                        ...
                        <div class="lt_banner_bottom" id="fadeFour" style="margin-top: 50.4%;">
                            ...
                            foreach ($banner_images['small_bottom_banner'] as $small_bottom_banner):
                                ...
                                if ($l > $left) {
                                    ...
                                    ?>
                                    <img src="<?php echo base_url() . 'images/admin/' . $small_bottom_banner->image_name; ?>" alt="Banner" class="img-responsive" width="100%" link="<?php
                                    if (!empty($small_bottom_banner->image_url)) {
                                        echo $small_bottom_banner->image_url;
                                    } else {
                                        echo '#';
                                    }
                                    ?>"/>
                        ...
                        <div class="col-lg-3 less_pad">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="search_select">
                                            <select id="country" name="country" onchange="return selectCountry(this.value);">
                                                <option value="0">--SELECT--</option>                                                 
                                                    ...
                                                    <option value="<?php echo $country->country; ?>" <?php
                                                        if ($cookie_details['country_value'] == $country->country) {
                                                            echo 'selected';
                                                        }
                                        ...
                                        <div class="search_radio">
                                            <input type="checkbox" onclick="return setCookiesForSearchCountry();" value="" name="country_remember" id="country_remember" <?php
                                                if (!empty($cookie_details['country_value'])) {
                                                    echo 'checked';
                                                }
                                                ?>/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="search_select">
                                            <select id="location" name="location" onchange="return checkCookiesCity(this.value);">
                                                        ...
                                                        if (!empty($cookie_details['city_value']) && !empty($cookie_details['country_value'])) {
                                                            foreach ($city_list as $city) {
                                                                ...
                                                                if ($city->city_id == $cookie_details['city_value']) {
                                                                    echo 'selected';
                                                                }
                                        ...
                                        <div class="search_radio">
                                            <input type="checkbox" value="" onclick="return setCookiesForSearchCity();" name="city_remember" id="city_remember" <?php
                                                if (!empty($cookie_details['city_value'])) {
                                                    echo 'checked';
                                                }
                                                ?>/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="search_select">
                                            <select id="retailer_id" name="brand" onchange="return retailerChangeForCookie(this.value);">
                                                <option value=" ">--SELECT--</option>
                                                <option value="0">All</option>                                                
                                                    <?php foreach ($shop_list as $shop): ?>
                                                    <option value="<?php echo $shop->id; ?>" <?php
                                                        if ($cookie_details['retailer_value'] == $shop->id) {
                                                            echo 'selected';
                                                        }
                                        ...
                                        <div class="search_radio"><input type="checkbox" onclick="return setCookiesForSearchRetailer();" value="" name="retailer_remember" id="retailer_remember" <?php
                                                        if (!empty($cookie_details['retailer_value'])) {
                                                            echo 'checked';
                                                        }
                                                        ?>/>                                            
                                            <a href="#" class="mytooltip">remember<span class="classic">Remember</span></a>
                                ...
                                <div class="first_row_wrap">
                                        ...
                                        <div class="col-lg-6 less_pad">
                                            <div class="<?php echo $class; ?>">
                                                ...
                                                <div class="btn_buy"><a href="<?php echo base_url(); ?>home/productDetails/<?php echo $special_deal->id; ?>">View Details</a></div>
                                                <?php $actual_link = base_url() . "home/productDetails/" . $special_deal->id; ?>
                                                <div class="social social_row_one">
                ...
                <!--<a href="<?php echo base_url('home/productDetails') . '/' . $coupon_deal->id; ?>">-->
                                            ...
                                            <div class="btn_buy"><a href="<?php echo base_url(); ?>home/productDetails/<?php echo $coupon_deal->id; ?>">View Details</a></div>
                                            <div class="social">
                    ...
                    <?php if (!empty($deals[1])): ?>
                            <div class="col-lg-4 less_pad">
                                ...
                                <div class="left">
                                    <div class="bg">
                                        <!--<a href="<?php echo base_url(); ?>home/productDetails/<?php echo $deals[1][0]->id; ?>">-->
                                        <img width="100%" class="img-responsive" alt="Product" src="<?php echo base_url() . 'images/deals/products/' . $deals[1][0]->banner; ?>">
                                            <!--</a>-->
                                    </div>
                                    <div class="content">
                                        <!--@ -->
                            ...
                            <div class="col-lg-4 less_pad">
                                ...
                                <div class="right">
                                    ...
                                    <div class="bg">
                                        <!--<a href="<?php echo base_url(); ?>home/productDetails/<?php echo $deals[1][1]->id; ?>">-->
                                        <img src="<?php echo base_url() . 'images/deals/products/' . $deals[1][1]->banner; ?>" alt="Product" class="img-responsive" width="100%" />
                                        <!--</a>-->
                                    </div>
                                    <div class="content">
                                        <!-- Unlimited -->
                                ...
                                foreach ($deals[1] as $product_index => $product) {
                                    ...
                                    if ($product_index > 1) {
                                        ...
                                        <div class="col-lg-6 less_pad resp_bottom">
                                            ...
                                            <div class="bg">
                                                <!--<a href="<?php echo base_url(); ?>home/productDetails/<?php echo $product->id; ?>">-->
                                                <img src="<?php echo base_url() . 'images/deals/products/' . $product->banner; ?>" alt="Product" class="img-responsive" width="100%" />
                                                <!--</a>-->
                                            </div>
                                            <div class="content">
...
<?php $this->load->view('front_include/footer.php'); ?>
        <script>
            ...
            function setCookiesForSearchCountry() 
                {
                    var country_value = $("#country").val();
                    if (document.getElementById("country_remember").checked == true) 
                        {
                            
                            $.ajax({
                                url: "<?php echo base_url('home/setCookiesForSearch'); ?>",
                                type: "POST",
                                data: {
                            ...
                            var country_cookie_value = $.cookie("country");
                            if(country_cookie_value == country_value)
                                    {                   
            ...
            function setCookiesForSearchCity() 
                {
                    var location = $("#location").val();
                    if (document.getElementById("city_remember").checked == true) 
                        {                   
                            $.ajax({
                                        url: "<?php echo base_url('home/setCookiesForSearch'); ?>",
                                        type: "POST",
                            ...
                            var city_cookie_value = $.cookie("city");
                            if(city_cookie_value == location)
                                {                   
                                    $.removeCookie("city");
                                }
                         }
            ...
            function setCookiesForSearchRetailer() 
                {
                    var retailer_id = $("#retailer_id").val();
                    if (document.getElementById("retailer_remember").checked == true) 
                        {
                            ...
                            var retailer_cookie_value = $.cookie("retailer");
                            if(retailer_cookie_value == retailer_id)
                                {                   
                                    $.removeCookie("retailer");
                                }                    
                         }
