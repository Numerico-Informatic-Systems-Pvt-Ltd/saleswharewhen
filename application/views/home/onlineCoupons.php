...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Saleswherewhen :: Online Coupons</title>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="container less_pad">
                ...
                <?php if(!empty($couponsCategory)){ ?>
<!--                <div class="col-lg-12">
                    <div class="sub_categ_wrap">
                        <div class="col-lg-12 less_pad"> first_row
                        	<div class="sub_categ">
                            	<ul id="flexiselDemo3">
                                <?php foreach($couponsCategory as $Category){ ?>
                                 <li>                                                   
                                    <ul class="caption-style-2">
                                        <li>
                                            <a href="<?php echo base_url().'home/onlineCoupons/'.$Category->id;?>">
                                        ...
                                        <div class="caption">
                                            ...
                                            <div class="caption-text">
                                                <h1><a href="<?php echo base_url().'home/onlineCoupons/'.$Category->id;?>"><?php echo $Category->category; ?></a></h1>
                                            </div>
                                        </div>
                                        </li>
                                    </ul>
...
<!--                            <div class="carousel-inner" role="listbox">
                                <div class="item active">
                                    <img src="http://sww.nisclient.com/images/admin/grocery_big11.jpg" alt="Grocery" class="img-responsive" width="100%" height="280px;">
                                </div>
                                <div class="item">
                                    <img src="http://sww.nisclient.com/images/admin/grocery_big11.jpg" alt="Grocery" class="img-responsive" width="100%" height="280px;">
                                </div>
                ...
                <div class="col-lg-12">
                    <div id="top" class="body_top_wrap cd-top">
                        <div class="col-lg-3 less_pad">
                            <?php 
                            $catcount = count($categoryDetails);
                            if(!empty($categoryDetails) && $catcount>1){  ?>                            
                            <h1>Coupons  <span>
                            <?php } else { 
                                if(!empty($onlineCoupons)){
                                ?>
                              <h1>   Coupons of  <span>  
                            <?php echo ($categoryDetails->category) ? $categoryDetails->category : '';  ?></span> <?php } else { echo '<h1>No Coupons Found'; } }  ?></h1>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="body_product_wrap" id="search_result_container">
                        ...
                        <div class="col-lg-12 less_pad"><!-- first_row-->
                            ...
                            <div class="col-lg-12 less_pad new_cate_list" id="pagination_online_coupons">
                                <?php
                                if (!empty($onlineCoupons)) {
                                    $i = 0;
                            ...
                            <div class="clearfix"></div>
                            <?php if (!empty($onlineCoupons)) { ?>
                                 <div class="col-lg-12"> 
                                            <nav>
                                                <ul class="pagination" id="trendingPagination">
                                                   <?php
                                                     $page_count = ceil($total_product/10);
...
function ajaxPagination(page){
   // alert(page);
        ...
        $("#pagination").val(page);
        $.ajax({
            url: "<?php echo base_url('home/onlineCouponsPagination'); ?>",
            type: "POST",
            data: {
                pagination:page,
            ...
            success: function (response) {
                //alert(response);
                $('#pagination_online_coupons').html();
                $('#pagination_online_coupons').html(response);
