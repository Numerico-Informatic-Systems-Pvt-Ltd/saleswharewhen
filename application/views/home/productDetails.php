...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="container-fluid">
			...
			<?php if(!empty($deal_details->parentCatg)){ ?>
                        <li class="breadcum_new"><a href="<?php echo base_url().'home/listing/'.$deal_details->parent_id; ?>"><?php echo $deal_details->parentCatg; ?></a></li>
			<?php } ?>
                        <li class="breadcum_new"><a href="<?php echo base_url().'home/listing/'.$deal_details->category_id; ?>"><?php echo $deal_details->category; ?></a></li>
                        ...
                        <div class="col-lg-12 less_pad">
                            <div class="col-lg-7 less_pad">
                                        ...
                                        <ol class="gallery-indicators">
                                            ...
                                            <?php foreach ($deal_images as $deal_image): ?>
                                                <li data-target="#carousel-example-generic" data-slide-to="2">
                                                    <img src="<?php echo base_url() . 'images/deals/thumb/' . $deal_image->deal_image; ?>" width="100%" class="gap" />
                                                </li>
                                            <?php endforeach; ?>
                                        </ol>
                                    </div>
                                    <div class="col-lg-10">
                                        <div class="carousel-inner" role="listbox">
                                            <div class="item active">
                                                <img src="<?php echo base_url() . 'images/deals/products/' . $deal_details->banner; ?>" width="100%" alt="Gallery" />
								...
								<p><?php if (isset($text[1])) {echo  $text[1];} ?></p>
                                            ...
                                            foreach ($deal_images as $deal_image): ?>
                                                <div class="item">
                                                    <img src="<?php echo base_url() . 'images/deals/products/'. $deal_image->deal_image ?>" width="100%" alt="Gallery" />
                                                    <div class="carousel-caption">
                                                      <div class="arrow-right">
				                    	<div>
                            ...
                            <div role="tabpanel" class="tab_marg">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation"><a href="#coupons" aria-controls="coupons" role="tab" data-toggle="tab">Coupons Available</a></li>
                                    <?php } ?>
                                </ul>

                                <!-- Tab panes -->
                                <div class="tab-content force-overflow" id="style-8">
...
<?php } ?>
						...
						?>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="coupons" >
                                        <p>  Please click on this links to check the coupons of <strong><?php echo ($deal_details->shop_name)? $deal_details->shop_name:''; ?></strong></p>
                                        <?php  
                                        ...
                                        <div style="margin-top:10px;">
                                            <a href="<?php echo base_url();?>home/productDetails/<?php echo $coupons->id;?>" ><?php echo $i.' . '.$coupons->deal_text.' on '.$coupons->product_name; ?></a> 
                                        </div>
                                        <?php $i++; } } ?>
					...
					<?php 
						...
						<?php } ?>
                            <!--<p>Review: 10</p>-->
                                            <!--<p>Sale Ends:<br><span id="defaultCountdown"> </span></p>-->
                                        </div>
                    ...
                    <?php }else{
                        ?> <p class="no_result">No Details Available Or May be Product Does Not Exist</p><?php
                    } ?>
                    <div class="clearfix"></div>
                </div>		
                <div class="col-lg-12 similar">
                    <?php if(!empty($deal_details)){ ?>
                    <h2>Similar items</h2>
                    <div class="body_product_wrap">
                                ...
                                foreach ($similarDeals as $similarDeal):                                    
                                    ...
                                    <div class="col-lg-6 less_pad">
                                        <div class="similar_product">
                                            <div class="left">
                                                <a href="<?php echo base_url().'home/productDetails/'.$similarDeal->id;?>"><img src="<?php echo base_url() . 'images/deals/listing/' . $similarDeal->banner; ?>" alt="Similar Product" class="img-responsive" /></a>
                                            </div>
                                            <div class="right">
