		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<!--<img src="<?php echo base_url(); ?>assets/img/Maher_ogo.png" alt="logo" />-->
                                <span style="color: #ffffff;font-size: 14px;font-weight: bold;margin:2px 0 2px 15px;">Saleswherewhen</span>
                                <span style="color: #fd300e;font-size: 14px;font-weight: bold;">.com</span>
				</a>
				<!-- END LOGO -->
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown user">
						...
						<!--<img alt="" src="<?php echo base_url(); ?>assets/img/avatar1_small.jpg" />-->
                                                    <span class="username">Hi, <?php  if(!empty($user_logged_name)){ echo $user_logged_name->first_name.' '.$user_logged_name->last_name; }?></span>
