...
<!-- END PAGE HEADER-->
<p style="font-weight:bold;">This section allows you to add the Shops.</p><br>
<!-- BEGIN PAGE CONTENT-->
<div class="row-fluid">
    <div class="span12">
        ...
        <div class="portlet box purple">
            <div class="portlet-title">
                <div class="caption"><i class="icon-asterisk"></i>Manage Shop</div>
                <div class="tools">
            ...
            <div class="portlet-body form">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span6 ">
                        <div class="control-group">
                            <label class="control-label">Shop City<span class="required">*</span></label>
                            <div class="controls">
                                ...
                                <?php echo form_error('shop_city', '<span class="req">', '</span>'); ?>
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
...
<!--                                <span class="label label-important"> Note !</span>
                    ...
                    <div class="span6 ">
                        <div class="control-group">
                            <label class="control-label">shop Logo<span class="required"></span></label>
                            <div class="controls">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
...
<!--                                <span class="label label-important"> Note !</span>
                ...
                <div class="row-fluid">
                	<div class="span6 ">
                        <div class="control-group">
                            <label class="control-label">Shop Address<span class="required">*</span></label>
                            <div class="controls">
                                ...
                                <?php echo form_error('shop_address', '<span class="req">', '</span>'); ?>
                ...
                <div class="row-fluid">
                	<div class="span6 ">
                        <div class="control-group">
                            <label class="control-label">Shop Link<span class="required">*</span></label>
                            <div class="controls">
                                <?php
                                $attributes = array(
                                    'name' => 'shop_url',
                    ...
                    <div class="span6 ">
                        <div class="control-group">
                            <label class="control-label">Shop Map Url<span class="required">*</span></label>
                            <div class="controls">
                                <textarea class="span6" name="shop_location_map" rows="6" data-error-container="#editor2_error"><?php echo !empty($shop_details->shop_location_map) ? $shop_details->shop_location_map: ''; ?></textarea>
                                <?php echo form_error('shop_location_map', '<span class="req">', '</span>'); ?>
                                <div id="editor2_error"></div>
                            </div>
                            <span class="label label-important"> Note !</span>
                            <span>
                            Map height & width should be set to(155,255) respectively!
                            </span>
                        </div>
                    </div>
                </div>
                <div class="row-fluid">
                	<div class="span6 ">
                        <div class="control-group">
                            <label class="control-label">Shop Highlights <span class="required"></span></label>
                            <div class="controls">
