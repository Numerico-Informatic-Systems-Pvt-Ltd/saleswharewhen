              ...
              <div class="modal-dialog">
                <div class="modal-content">
									...
									url: "<?php echo base_url('home/insertAlertSeesion'); ?>",
											...
											success: function(data){
												//alert("Successfully add to the alert cart");
                                                                                                bootbox.dialog({
                                                                                                message: "Successfully added to the alert cart",
                                                                                                title: "Added to Alert Me Cart",
                                                                                                buttons: {
                                                                                                  danger: {
                                                                                                  ...
                                                                                                  main: {
                                                                                                    ...
                                                                                                    callback: function() {
                                                                                                      ...
                                                                                                      self.location = "<?php echo base_url('home/alertMeCart');?>";
                  ...
                  <div class="modal-body">
					...
					?>
                            <option value = "<?php echo $brand->id; ?>"><?php echo $brand->category; ?></option>
                    <?php
						}
					?>
                        </select>
					...
					?>
                        ...
                        <div class="action_btns">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 less_pad">
                                    <!--<a href = "<?php echo base_url('home/alertMeCart'); ?>"><input type="button" class="alert_popup_btn col-sm-3 pull-right" value="Done"></a>-->
                                    <input type="submit" class="alert_popup_btn col-sm-9 pull-right" value="Add to Alert me Cart" style = "width: 160px;"></input>
                                </div>
                            </div>
                        </div>
